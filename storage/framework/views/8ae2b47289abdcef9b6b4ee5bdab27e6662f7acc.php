    ...
    <div class="container">
      <nav class="menuzord js-primary-navigation" role="navigation" aria-label="Primary Navigation">
        ...
        <ul style="min-width:82%" class="menuzord-menu menuzord-right c-nav_s-standard">
          <li class="<?php echo isActive('index', $page) ?>"><a href="<?php echo e(url('/')); ?>">home</a>
          </li>
          <li class="<?php echo isActive('aboutus', $page) ?>"><a href="<?php echo e(url('/aboutus')); ?>">about us</a>
          </li>
          <li class="<?php echo isActive('services', $page) ?>"><a href="<?php echo e(url('/services')); ?>">Our services</a>
          </li>                
          <li class="<?php echo isActive('newsroom', $page) ?>"><a href="<?php echo e(url('/newsroom')); ?>">News room</a>
          </li>
          <li class="<?php echo isActive('contact', $page) ?>"><a href="<?php echo e(url('/contactus')); ?>">contact us</a>
          </li>
