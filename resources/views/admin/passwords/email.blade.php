    ...
    <div class="login-page">
        <div class="post-img">
            ...
            <div class="form">
                ...
                @endif
                <form id="main-contact-form" class="contact-form" name="contact-form" method="POST" action="{{ route('admin.password.email') }}" role="form">
                    {{ csrf_field() }}

                    <div class="row">
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            <input id="email" type="email" class="form-control" name="email" required="required" value="{{ old('email') }}" placeholder="Admin Email">
                            @if ($errors->has('email'))
