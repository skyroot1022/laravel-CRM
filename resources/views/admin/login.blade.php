...
<body class="bg-gray" style="position:relative">
    ...
    <div class="login-page">
        <div class="post-img">
            ...
            <div class="form">
                <form id="main-contact-form" class="contact-form" name="contact-form" method="POST" action="{{ route('admin.login') }}" role="form">
                    {{ csrf_field() }}

                    <div class=" subscribe-box p-tb-50 text-center">
                        <h2 class="heading-semibold">Admin Log in</h2>                    
                    </div>
                    <div class="row">
                    ...
                    <div class="form-group">
                        <div class="checkbox">
                            ...
                            <div class="float-right">
                                <a class="right-align" href="{{ route('password.request') }}">
                    ...
                    <p> Do you have an account?&nbsp&nbsp&nbsp<a href="{{ route('admin.register') }}">Sign up</a></p>                    
                </form>            
            </div>
        </div>
    </div>
